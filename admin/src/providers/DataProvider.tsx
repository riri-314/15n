...
import {collection, doc, DocumentData, getDoc, getDocs, limit, orderBy, query, where,} from "firebase/firestore";
...
export const DataProvider: React.FC<DataProviderProps> = ({children}) => {
    ...
    return (<DataContext.Provider value={{data, refetchData, fetchedTime}}>
            {children}
